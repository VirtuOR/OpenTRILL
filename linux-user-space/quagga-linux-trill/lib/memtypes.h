...
enum
{
  ...
  MTYPE_ISIS_NEXTHOP,
  MTYPE_ISIS_NEXTHOP6,
  MTYPE_ISIS_TRILLAREA,
  MTYPE_ISIS_TRILL_NICKDB_NODE,
  MTYPE_ISIS_TRILL_FWDTBL_NODE,
  MTYPE_ISIS_TRILL_VLANS,
  MTYPE_ISIS_TRILL_ADJVLANS,
  MTYPE_ISIS_TRILL_VLANBRIDGE_ROOTS,
  MTYPE_ISIS_TRILL_BRIDGE_ROOTIDS,
  MTYPE_ISIS_TRILL_VLANSREACHABLE,
  MTYPE_ISIS_TRILL_VLANFWDERS,
  MTYPE_ISIS_TRILL_ENABLEDVLANS,
  MTYPE_ISIS_TRILL_VLANSUBTLV,
  MTYPE_ISIS_TRILL_INHIB,
  MTYPE_VTYSH_CONFIG,
